 ...
 * inert so the existing raw-WASM loader can continue to instantiate the module
 * without introducing a second wasm-bindgen runtime.
 */
...
function rawWasmImports(module: WebAssembly.Module): RawWasmImportSet {
