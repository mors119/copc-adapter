/**
 * Public Cesium adapter entrypoint.
 *
 * This is the explicit renderer-specific package path. The historical root
 * entrypoint re-exports the same Cesium API for backwards compatibility.
 */
